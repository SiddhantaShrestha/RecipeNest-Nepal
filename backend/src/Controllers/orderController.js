...
const markOrderAsPaid = async (req, res) => {
  try {
    ...
    // Extract payment details with fallbacks for different payment gateways
    const paymentDetails = {
      id: req.body.id || req.body.transaction_id || "unknown",
      status: req.body.status || "COMPLETED",
      update_time: req.body.update_time || new Date().toISOString(),
      email_address:
        req.body.payer?.email_address || order.user.email || "not-provided",
    };
